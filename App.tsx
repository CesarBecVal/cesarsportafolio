...
const App: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen font-sans text-slate-300 selection:bg-accent/30 selection:text-white">
      ...
      <nav
        className={`fixed top-6 left-1/2 -translate-x-1/2 z-40 hidden md:flex items-center rounded-full px-4 py-3 transition-all duration-500 animate-in fade-in slide-in-from-top-8 duration-700 ${isScrolled
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
            ...
            <div className="flex flex-col justify-center items-start order-2 lg:order-1">
              ...
              <div className="flex flex-wrap gap-4 animate-in slide-in-from-bottom-4 duration-700 delay-500">
                ...
                <Button variant="outline" href={cvPdf} download="CV_CesarBV.pdf" className="group">
